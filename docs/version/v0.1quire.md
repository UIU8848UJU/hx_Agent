...
- [AI 文档整理与知识库 Agent v0.1 需求文档（SQLite First）](#ai-文档整理与知识库-agent-v01-需求文档sqlite-first)
  ...
  - [8. 验收标准（月底 v0.1）](#8-验收标准月底-v01)
  - [9. 里程碑建议（你开工就照这个拆）](#9-里程碑建议你开工就照这个拆)
  - [10. Python + C++ 混合的技术约束（预埋，不拖慢 v0.1）](#10-python--c-混合的技术约束预埋不拖慢-v01)
...
3. ask 在 20 条你真实问题里，至少 70% 你觉得“能省时间”
...
* M1：SQLite 表结构 + ingest（扫描/增量/hash/写库）✅
* M2：FTS5 search + 引用定位输出 ✅
* M3：ask（缝合 + 结构化输出，LLM 可选）✅
* M4：reformat（至少 SOP 模板跑通）✅
* M5：doctor + 最小 eval（20 条问题集）✅
  
---
  
## 10. Python + C++ 混合的技术约束（预埋，不拖慢 v0.1）
